...
EXTENSION_NAME=QUACKML
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="quackml" \
...
#### Main build
# For regular CLI build, we link the quackml extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/quackml/quackml.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/quackml/quackml.duckdb_extension'
